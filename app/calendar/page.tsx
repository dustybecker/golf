          ...
          {entries.map((entry) => {
            if (entry.kind === "group") {
              ...
              return (
                <Link
                  ...
                  className={`soft-card block rounded-[1.5rem] border ${style.border} bg-surface/35 p-5 hover:bg-surface/60`}
                >
                  ...
                  <h2 className="mt-2 text-lg font-semibold text-text">
                    NFL Weekly Picks (Weeks 1–{entry.events.length})
                  </h2>
                  <p className="mt-1 text-xs text-muted">
                    {formatRange(first.starts_at, last.ends_at ?? last.starts_at)}
                  </p>
                  <p className="mt-1 text-xs text-muted">
                    Pick 5 games ATS each week · each week scores independently
                  </p>
                </Link>
              );
            }
            ...
            return (
              ...
              >
                ...
                <h2 className="mt-2 text-lg font-semibold text-text">{ev.name}</h2>
